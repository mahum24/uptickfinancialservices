...
const Requiredskills = [
    "Bachelor’s Degree, or equivalent work experience demonstrating   proficiency in  marketing, sales, or customer service",
    "Excellent communication skills",
    "Excellent interpersonal skills",
    "Organized individual who excels in problem solving and multitasking",
    "Motivated hard worker who displays self-confidence and a strong desire to learn",
    "Energetic self-starter",
    "Management skills are desirable but not required"
...
const Partner = () => {
    ...
    return (
        <div className='w-full'>
            ...
            <div className='bg-white shadow-lg w-full flex justify-center  md:justify-start lg:justify-center items-start pt-10 pb-10 flex-wrap'>
                ...
                <div className='w-full sm:w-1/2 md:w-[40%] md:ml-7 lg:w-1/4 mx-2'>
                    <div className='mx-5'>
                        ...
                        <p className='text-sm font-light text-gray-600 mb-4'>As a full-service independent financial service professional, you will be creating customized plans to meet client needs in the following areas:</p>
                        <ul className="list-disc list-inside text-sm font-light text-gray-600 ml-5">
                            {gain.map((gain, index) => (
                                <li key={index} className="mb-1">{gain}</li>
                            ))}
                        </ul>
                    </div>
                </div>
            </div>
            <div className='flex justify-around bg-gray-100 pb-4'>
                <div className='text-center'>
                    <h1 style={{ color: 'rgb(4, 80, 116)' }} className='text-center w-full font-bold text-4xl mt-9'>Position</h1>
                    <p className='text-3xl text-[#747474]'>Full Time / Part Time</p>
                </div>
                <div className='text-center'>
                    <h1 style={{ color: 'rgb(4, 80, 116)' }} className='text-center w-full font-bold text-4xl mt-9'>Compensation</h1>
                    <p className='text-3xl text-[#747474]'>Variable pay / Commissions only</p>
                </div>
            </div>
            <GetStartedForm/>
